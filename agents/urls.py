...
urlpatterns = [
    ...
    path('api/conversations/new/messages/add/', views.add_message, {'conversation_id': 'new'}, name='new_conversation_message'),
    
    # Direct agent messages (for card clicks)
    path('api/direct-agent-message/', views.direct_agent_message, name='direct_agent_message'),
    ...
    path('api/conversations/<int:conversation_id>/stream-audio-chunk/', views.stream_audio_chunk, name='stream_audio_chunk'),
    path('api/conversations/new/stream-audio-chunk/', views.stream_audio_chunk, name='stream_audio_chunk_new'),
    ...
    path('mental-health/detect-mood/', views.mental_health_mood_detect, name='mental_health_mood_detect'),
